            ...
            <div>
                ...
                <div className="drawer-side mt-[72px]">
                    ...
                    <div className="menu bg-base-200 text-base-content min-h-full w-80 p-4 leading-7">
                        <label htmlFor="my-drawer" aria-label="close sidebar"><a>Home</a></label>
                        <label htmlFor="my-drawer" aria-label="close sidebar"><a>Products</a></label>
                        <label htmlFor="my-drawer" aria-label="close sidebar"><a>New Arrivals</a></label>
                        <label htmlFor="my-drawer" aria-label="close sidebar"><a>Categories</a></label>
                    </div>
                </div>
            </div>
